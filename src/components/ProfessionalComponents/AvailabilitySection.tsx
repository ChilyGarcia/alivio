    ...
    <div className="space-y-6">
      ...
      {activeTab === "tarifa" && (
        <div className="flex justify-center items-center w-full">
          <div className="bg-white rounded-lg shadow p-6 border border-gray-200 w-full max-w-md">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-7 rounded-md border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-primary"
                    required
                  />
                </div>
              </div>
            ...
            {currentRate.hourly_rate !== "" && (
              <div className="mt-4 text-sm text-gray-600">
                ...
                <span className="font-semibold">
                  {parseFloat(currentRate.hourly_rate).toLocaleString("es-CO", {
                    style: "currency",
                    currency: "COP",
