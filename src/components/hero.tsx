    ...
    <div className="overflow-hidden">
            ...
            <div className="flex flex-row items-center gap-2">
              <div className="flex-1 relative">
                <input
                  ...
                  className="w-full px-4 py-2 pr-10 border-2 border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all text-sm"
                />
      ...
      >
        <div>
          ...
          <div className="flex justify-center items-center my-12 md:my-16 md:justify-start md:pl-12 lg:pl-20 pb-8 md:pb-10 w-full">
